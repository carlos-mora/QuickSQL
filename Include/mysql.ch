/*
 * $Id: mysql.ch 8659 2008-06-08 10:22:37Z vszakats $
 */
...
#define  NOT_NULL_BIT           0     /* Field can't be NULL */
#define  PRI_KEY_BIT            1     /* Field is part of a primary key */
#define  UNIQUE_KEY_BIT         2     /* Field is part of a unique key */
#define  MULTIPLE_KEY_BIT       3     /* Field is part of a key */
#define  BLOB_BIT               4    /* Field is a blob */
#define  UNSIGNED_BIT           5    /* Field is unsigned */
#define  ZEROFILL_BIT           6    /* Field is zerofill */
#define  BINARY_BIT             7
/* The following are only sent to new clients */
#define  ENUM_BIT               8   /* field is an enum */
#define  AUTO_INCREMENT_BIT     9   /* field is a autoincrement field */
#define  TIMESTAMP_BIT          10  /* Field is a timestamp */
#define  PART_KEY_BIT           14 /* Intern; Part of some key */
#define  GROUP_BIT              15 /* Intern group field */
